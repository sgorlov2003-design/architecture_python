"""Домашнее задание 03. Вариант 14 — Фитнес-трекер. FastAPI + PostgreSQL + JWT."""
...
app = FastAPI(
    ...
    description="ДЗ 03, вариант 14 — REST API с персистентным хранением в PostgreSQL",
    version="1.0.0",
    lifespan=lifespan,
)
...
def list_exercises():
    ...
    with db.connection() as conn:
        with conn.cursor() as cur:
            ...
            rows = cur.fetchall()
    return [ExerciseResponse(id=r[0], name=r[1], description=r[2]) for r in rows]
